...
displaying the active filter's condition text centered on the row in white on a
blue background; when no filter is active the row is not shown and the board area
